...
class Controller
{
	 ...
	 * @return mixed
	 */
	protected function _getParam(string $key, $default = null) : mixed
	{
		// tests against the named parameters first
		if (isset($this->_namedParameters[$key])) {
			return $this->_namedParameters[$key];
		}
		// si no existe la $key en el array _namedParameters:
		// tests against the GET/POST parameters. Los busca en objeto Request
